...
// Make changes to ADPBook.m instead.

#import "_ADPBook.h"

const struct ADPBookAttributes ADPBookAttributes = {
	.isFavorite = @"isFavorite",
	.title = @"title",
};

const struct ADPBookRelationships ADPBookRelationships = {
...
@implementation ADPBookID
@end

@implementation _ADPBook
...
- (ADPBookID*)objectID {
	return (ADPBookID*)[super objectID];
}
