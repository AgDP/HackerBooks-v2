...
// Make changes to ADPTag.m instead.

#import "_ADPTag.h"

const struct ADPTagAttributes ADPTagAttributes = {
	.name = @"name",
};

const struct ADPTagRelationships ADPTagRelationships = {
	.books = @"books",
};

@implementation ADPTagID
@end

@implementation _ADPTag
...
- (ADPTagID*)objectID {
	return (ADPTagID*)[super objectID];
}
