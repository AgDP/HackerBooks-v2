...
// Make changes to ADPAuthor.m instead.

#import "_ADPAuthor.h"

const struct ADPAuthorAttributes ADPAuthorAttributes = {
	.name = @"name",
};

const struct ADPAuthorRelationships ADPAuthorRelationships = {
	.books = @"books",
};

@implementation ADPAuthorID
@end

@implementation _ADPAuthor
...
- (ADPAuthorID*)objectID {
	return (ADPAuthorID*)[super objectID];
}
